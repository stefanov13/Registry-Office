    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('signatory_department', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='user_profiles.departmentsmodel', verbose_name='Signatory Department')),
                ('signatory_profile', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='user_profiles.profile', verbose_name='Signatory Profile')),
            ],
        ),
    ]

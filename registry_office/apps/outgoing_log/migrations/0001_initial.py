    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('concerned_employees', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='user_profiles.employeepositionsmodel', verbose_name="Signatory Employee's ID")),
            ],
        ),
    ]
